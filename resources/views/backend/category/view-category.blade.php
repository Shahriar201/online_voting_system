                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{ $category->id }}">
                                        ...
                                        @php
                                            $count_category = App\Model\Candidate::where('category_id', $category->id)->count();
                                        @endphp
                                        ...
                                        <td>
                                            ...
                                            @if ($count_category<1)
                                                <a title="Delete" id="delete" class="btn btn-sm btn-danger" href="{{ route('categories.delete', $category->id) }}">
